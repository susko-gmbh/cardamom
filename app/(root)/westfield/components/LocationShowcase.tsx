      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-20 sm:mb-28 lg:mb-36">
          ...
          <div className="order-1 lg:order-2 space-y-4 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-6 sm:mb-8">
              Unsere neue Location im Westfield Hamburg-Überseequartier bietet
              eine einzigartige Kombination aus moderner Eleganz und
              authentischer indischer Gastronomie. Die sorgfältig gestaltete
              Innenarchitektur schafft eine warme, einladende Atmosphäre, die
              sowohl für geschäftliche Treffen als auch für romantische Abende
              perfekt ist.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-20 sm:mb-28 lg:mb-36">
          <div className="space-y-4 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-6 sm:mb-8">
              Unsere moderne Küche ist mit hochwertiger Ausstattung
              ausgestattet und bietet unseren erfahrenen Köchen die perfekte
              Umgebung, um traditionelle indische Rezepte mit zeitgemäßer
              Präsentation zu kreieren. Die angeschlossene Bar serviert eine
              sorgfältig kuratierte Auswahl an Getränken.
            </p>
            <div className="space-y-3 sm:space-y-4 w-full sm:w-11/12">
              <div className="flex items-center gap-3 sm:gap-4 py-3 sm:py-4 bg-card px-4 sm:px-6 border-s-4 sm:border-s-6 border-primary">
        ...
        {/* Location & Address */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-16 sm:mb-20 lg:mb-24">
          <div className="order-2 lg:order-1">
            <div className="relative aspect-[4/3] overflow-hidden">
              <Image
              ...
              <div className="absolute bottom-0 flex flex-col sm:flex-row sm:items-center sm:justify-between left-0 bg-card/90 backdrop-blur-sm p-4 sm:p-6 w-full gap-3 sm:gap-0">
                <div>
                  <h4 className="text-lg sm:text-xl lg:text-2xl font-semibold text-foreground mb-1">Überseeboulevard 7</h4>
                  <p className="text-sm sm:text-base text-muted-foreground mb-2 sm:mb-0">20457 Hamburg</p>
                </div>
                <button className="group relative overflow-hidden bg-transparent border border-primary text-primary px-3 sm:px-4 lg:px-6 py-2 font-light text-xs sm:text-sm capitalize hover:bg-primary hover:text-white transition-all duration-500 flex items-center justify-center gap-2 w-full sm:w-auto">
                  <span className="relative z-10 transition-transform duration-500 group-hover:translate-x-11 text-center">
                    Zentrale Lage
                  </span>
          ...
          <div className="order-1 lg:order-2 space-y-4 sm:space-y-6">
            <div>
              <span className="text-primary/80 text-base sm:text-lg font-light tracking-wide mb-3 sm:mb-4 block">
                Lage
              </span>
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4 sm:mb-6">
                Zentrale Position
              </h3>
              <div className="w-12 sm:w-16 h-px bg-primary mb-4 sm:mb-6"></div>
            </div>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-6 sm:mb-8">
              Unsere neue Location befindet sich im Westfield
              Hamburg-Überseequartier, im Herzen des modernen
              Hafencity-Bereichs. Die zentrale Lage macht uns zum idealen
              Treffpunkt für Geschäftsleute, Touristen und Einheimische
              gleichermaßen. Einfach erreichbar mit öffentlichen
              Verkehrsmitteln und in unmittelbarer Nähe zu wichtigen
              Sehenswürdigkeiten.
            </p>
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center gap-3 sm:gap-4 py-3 sm:py-4 bg-card px-4 sm:px-6 border-s-4 sm:border-s-6 border-primary">
                ...
                <div>
                  ...
                  <span className="text-xs sm:text-sm text-muted-foreground">Überseeboulevard 7, 20457 Hamburg</span>
                </div>
              </div>
              <div className="flex items-center gap-3 sm:gap-4 py-3 sm:py-4 bg-card px-4 sm:px-6 border-s-4 sm:border-s-6 border-primary">
                ...
                <div>
                  ...
                  <span className="text-xs sm:text-sm text-muted-foreground">+49 40 80 08 04 18</span>
                </div>
              </div>
              <div className="flex items-center gap-3 sm:gap-4 py-3 sm:py-4 bg-card px-4 sm:px-6 border-s-4 sm:border-s-6 border-primary">
