          ...
          <div className="order-2 lg:order-1">
            <div className="relative aspect-[4/3]  overflow-hidden">
              ...
              <div className="absolute bottom-0 flex items-center justify-between left-0 bg-card/90 backdrop-blur-sm p-6 w-full">
                <div className="">
                  <h4 className="text-2xl font-semibold text-foreground mb-1">Überseeboulevard 7</h4>
                  <p className="text-muted-foreground mb-2">20457 Hamburg</p>
                </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 py-4 bg-card px-6 border-s-6 border-primary">
                ...
                <div>
                  ...
                  <span className="text-muted-foreground">Überseeboulevard 7, 20457 Hamburg</span>
                </div>
              </div>
              <div className="flex items-center gap-4 py-4 bg-card px-6 border-s-6 border-primary">
